...
class DicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dica" do
    assert_difference("Dica.count") do
      post dicas_url, params: { dica: { descricao: @dica.descricao, genero: @dica.genero, nota: @dica.nota, titulo: @dica.titulo } }
    end
  ...
  test "should update dica" do
    patch dica_url(@dica), params: { dica: { descricao: @dica.descricao, genero: @dica.genero, nota: @dica.nota, titulo: @dica.titulo } }
